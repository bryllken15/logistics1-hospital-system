-- Final Migration Script for Username/Password Authentication
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
    ...
    -- Step 4: Remove old email column if it exists
    ...
    -- Step 6: Temporarily disable foreign key constraints
    SET session_replication_role = replica;
    
    -- Step 7: Insert users one by one to avoid constraint issues
    ...
    -- Step 9: Add constraints after inserting data
...
-- Step 10: Create authentication functions
...
-- Step 12: Create user dashboard view
