...
console.log('🔍 TESTING SIMPLIFIED CONNECTIVITY...\n')

async function testSimplifiedConnectivity() {
  try {
    console.log('1️⃣ Testing Purchase Requests (Basic query)...')
    
    // Test purchase_requests table with basic query
    ...
    if (purchaseError) {
      ...
      if (purchaseRequests && purchaseRequests.length > 0) {
        ...
        console.log('   Requested by ID:', purchaseRequests[0].requested_by)
      }
    }
    ...
    console.log('\n🎯 SIMPLIFIED CONNECTIVITY RESULTS:')
    console.log('==================================')
    ...
    console.error('💥 Simplified connectivity test failed:', error)
  }
}

testSimplifiedConnectivity()
