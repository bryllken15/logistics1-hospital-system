-- SIMPLE AUTH FIX - Minimal Authentication Setup
-- This script creates the authenticate_user function and users without department column
...
-- Create the authenticate_user function (without department)
...
-- Create users table if it doesn't exist (minimal schema)
...
-- =====================================================
-- STEP 4: INSERT/UPDATE ALL TEST USERS (NO DEPARTMENT)
-- =====================================================
